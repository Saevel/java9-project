package prv.zielony.sample.project.dao.cassandra;
...
public class CassandraRepository<IdType, EntityType extends PersistenceId<IdType>> implements Repository<IdType, EntityType> {
